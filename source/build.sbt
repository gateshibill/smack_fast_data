...
resolvers += "Typesafe Releases" at "https://repo1.maven.org/maven2"
...
libraryDependencies ++= 
  Seq(
    ...
    "com.typesafe.akka" % "akka-zeromq_2.11" % "2.3.16" % Provided,
    "com.datastax.cassandra" % "cassandra-driver-core" % "3.2.0" % Provided,
    ...
    "io.netty" % "netty-handler" % "4.1.11.Final" % Provided,
    "io.netty" % "netty-transport-native-epoll" % "4.1.11.Final" % Provided,
    ...
    "com.outworkers" % "phantom-dsl_2.11" % "2.9.2" % Provided,
    ...
    "com.datastax.spark" % "spark-cassandra-connector_2.11" % "2.0.0-M1" % Provided, 
    ...
    "org.influxdb" % "influxdb-java" % "2.7" % Provided,
    ...
    "org.apache.flink" % "flink-streaming-scala_2.11" % "1.2.1", 
    "org.apache.flink" % "flink-streaming-connectors-parent_2.11" % "0.10.2",
    ...
    "org.apache.flink" % "flink-connector-cassandra_2.11" % "1.7.2",
